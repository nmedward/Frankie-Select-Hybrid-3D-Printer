...
module x_carriage_base(){
    ...
    translate([-33/2,0,0]) rotate([0,0,90]) horizontal_bearing_base(1, 45);
    // Upper bearing holder
    translate([-33/2,45,0]) rotate([0,0,90]) horizontal_bearing_base(1, 45);
    // Base plate
    ...
    difference(){   
        union(){
            //body
            translate([-33/2 - 2.5-8.5,-17-3,3])cube([8.5,14,22]);
            translate([-33/2 + 2.5,-17-3,3])cube([8.5,14,22]);   
        ...
        //left cutout
        translate([-18,-35,0]) translate([0,-11.5,-1]) rotate([0,0,135]) translate([0,-15,0]) cube([30,30,34]);
    }   
...
module x_carriage_holes(){
    // Lower bearing holder holes cutter
    translate([-33/2,0,0]) rotate([0,0,90]) horizontal_bearing_holes(1, 45);
    // Upper bearing holder holes cutter
    translate([-33/2,45,0]) rotate([0,0,90]) horizontal_bearing_holes(1, 45, true);
    ...
    translate([+12.5-3.5-2,-15,-1])rotate([0,90-65,0])cube([10,1155,30]);
    translate([-55.5+6.7+2,-10,-10])rotate([0,-90+65,0])cube([10,140,30]);
...
module x_carriage_fancy(){
    ...
    // Bottom ĺeft corner
    translate([-34,2,0]) translate([-4,-11.5,-1]) rotate([0,0,-145]) translate([0,-15,0]) cube([30,30,34]);
    // Top left corner
