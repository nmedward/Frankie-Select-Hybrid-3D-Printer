...
difference()
{
    ...
    {    
        // body
        // round body
        translate([-2.65,0,0]) translate([-5.5,36.5,6])rotate([-90,0,0])cylinder(r=8.5, h=19, $fn=20);
        // body block
    ...
    // PINDA lower hole
    translate([-2.65,0,0])translate([-5.5,50,6])rotate([-90,0,0])cylinder(r=4.1, h=40, $fn=20);
    ...
    translate([0,-5.25,0]){
        ...
        translate([-2.65,0,0]){
            ...
            //translate([2,40,11.5])rotate([0,90,0])cylinder(r=1.5, h=3+2.65, $fn=20); 
            //translate([2,40,12])rotate([0,90,0])cylinder(r=1.5, h=3+2.65, $fn=20); 
            //translate([2,40,12.5])rotate([0,90,0])cylinder(r=1.5, h=3+2.65, $fn=20); 
        }
        // M3 nuts opening
    ...
    //PINDA mounting hole
    translate([-2.65,0,0])translate([-5.5,60,6])rotate([90,0,0])cylinder(r=3.9, h=30, $fn=20); 
    translate([-2.65,0,0])translate([-5.5,41,6])rotate([90,0,0])cylinder(r=4.1, h=5, $fn=20); 

    // bottom cut
    translate([-2.65,0,0]) translate([-15,51,-1])  cube([25 , 8,20]);
    
    // top and bottom probe washer cutout
    translate([-8.15,37.05,6])rotate([90,0,0])cylinder(d=14.75, h=0.8, $fn=20);
    translate([-8.15,51.3,6])rotate([90,0,0])cylinder(d=14.75, h=0.85, $fn=20);

    translate([-2.65,0,0]){
    for ( i = [0 : 14] )
        {
          translate([-5.5,39+i,6])rotate([90,0,0])cylinder(r1=4.3, r2=2.8, h=1, $fn=20); 
          translate([-5.5,40+i,6])rotate([90,0,0])cylinder(r1=2.8, r2=4.3, h=1, $fn=20);
        }
    }
}
...
ext_body();
    ...
    translate([-8.15,41,6])rotate([90,0,0])cylinder(r=4.5, h=50, $fn=40); 
