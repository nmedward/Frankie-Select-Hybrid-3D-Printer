# This is the firmware that was used by Tom in his Dolly build.
This is the firmware I will be using to start out and then likely upgrading to a newer version once I get a better feel for the project. I will be modifying the configurations to be compatable with the parts from the MakerSelect V2.

## Marlin 3D Printer Firmware Original README
